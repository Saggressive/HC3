...
def main(data_path,model_path,lang,mul):
...
if __name__=="__main__":
    # print("ours")
    # acc=main(data_path="ours_dataset_v4/en/test_ours.jsonl",model_path="model/english_t5_epochs4_lr1e-4_d4_wp0_wd0_acc1_bs32/ours",lang="en",mul=True)

    # print("hc3")
    # acc=main(data_path="ours_dataset_v4/en/test_hc3.jsonl",model_path="model/english_t5_epochs4_lr1e-4_d4_wp0_wd0_acc1_bs32/hc3",lang="en",mul=True)

    acc=main(data_path="ours_dataset_v4/zh/test_ours.jsonl",model_path="model/chinese_t5_epochs4_lr1e-4_d4_wp0_wd0_acc1_bs32/ours",lang="zh",mul=True)
    acc=main(data_path="ours_dataset_v4/zh/test_hc3.jsonl",model_path="model/chinese_t5_epochs4_lr1e-4_d4_wp0_wd0_acc1_bs32/hc3",lang="zh",mul=True)