...
def parser_args():
    ...
    parser.add_argument('--train_path', default='ours_dataset_v2/en/train.jsonl', type=str)
    parser.add_argument('--hc3_val_path', default='ours_dataset_v2/en/val_hc3.jsonl', type=str)
    parser.add_argument('--ours_val_path', default='ours_dataset_v2/en/val_ours.jsonl', type=str)
