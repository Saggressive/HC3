...
epochs=$3
wp=$4
name=chinese_t5_epochs${epochs}_lr${lr}_d4_wp${wp}_wd0_acc1_bs32
CUDA_VISIBLE_DEVICES=$device nohup /share/miniconda3/envs/llama/bin/python run_s2s.py \
--train_path ours_dataset_v4/zh/train.jsonl \
--hc3_val_path ours_dataset_v4/zh/val_hc3.jsonl \
--ours_val_path ours_dataset_v4/zh/val_ours.jsonl \
